...
import en from '../lang/en/about'
import es from '../lang/es/about'
  ...
  return (
    <>
      ...
      <NextSeo
        ...
        canonical={absoluteUrl('/recommendations')}
        ...
        openGraph={{
          ...
          images: [
            {
              url: '/img/hero/about-us-lifexpeditions.jpg',
              width: 1400,
              height: 465,
              type: 'image/jpg',
            }
      ...
      <Hero title={t.title} image='/img/hero/aboutus-team.webp' image_min='/img/hero/about-us-lifexpeditions.jpg' />
      
      <section>
        <div className='2xl:container mx-auto'>
          <div className="lg:mx-20 mx-4 my-12">
            <div className="lg:flex  lg:space-x-12">
              <div className="lg:w-1/2">
                <h2 className="font-manrope text-4xl text-center lg:text-left text-gray-900 mb-6 ">
                {t.h2titlehistoriy}
                </h2>
              ...
              <div className="lg:w-1/2 flex justify-center lg:justify-end mt-8 lg:mt-0">
                <iframe
                  className="w-full h-64 md:h-80 lg:h-96 rounded-lg shadow-lg transform transition-transform duration-300 hover:scale-105"
                  src="https://www.youtube.com/embed/OvJCIqfjtcE?si=n-OYlYKRPz8ToRxJ"
          ...
          <div className="flex justify-center pb-2">
            <p className="relative rounded-full px-4 py-1.5 text-sm leading-6 text-gray-600 ring-1 ring-inset ring-gray-900/10 hover:ring-gray-900/20">
                <span className="hidden md:inline">{t.spmPeruOffer}</span>
                <a href="#" target="_blank" className="font-semibold text-secondary ">
                    <span className="absolute inset-0" ></span> {t.spmSeetour}<span>→</span>
                </a>
            </p>
          </div>

          <div className="lg:mx-20 mx-4">
            <div className="lg:flex  lg:space-x-12 pb-10 lg:pb-20">
              <div className="lg:w-1/2 flex justify-center lg:justify-end lg:mt-0">
                <div className="mt-10 flow-root sm:mt-10">
                    <div className="-m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4">
                          
                      <LazyLoadImage src="/img/other/popular-tours.webp" className="rounded-md shadow-2xl ring-1 ring-gray-900/10" />
                    </div>
                </div>
              </div>
              <div className="lg:w-1/2  content-center lg:pt-0 pt-10">
                  <h2 className="font-manrope text-4xl text-center lg:text-left text-gray-900 mb-6 ">{t.h2MisionValues}</h2>
                  <p className="text-lg text-gray-700 leading-relaxed text-justify flex justify-center ">{t.pMsisionValues}</p>
              </div>
            </div>
          </div>
          ...
          <div className='lg:mx-20 mx-2 my-8' >
            <div className='px-2 lg:px-32'>
              <h2 className="text-4xl text-center font-bold text-gray-900 mb-6">{t.h2WhyUs}</h2>
              <h3 className="text-2xl text-center font-bold text-gray-900 mb-6">{t.h3Sustainability}</h3>
              <p className="text-lg text-gray-500 text-center">{t.pSustainability}</p>
            </div>

            <div className="text-gray-700 body-font">
              <div className="container mx-auto">
                <div className="flex flex-wrap text-center justify-center bg-white shadow rounded">
                  <div className="md:w-1/4 sm:w-1/2">
                    <div className="px-4 py-6 transform transition duration-500 hover:scale-110">
                      <div className="flex justify-center">
                        <img src="/assets/icon/camping.svg" className="w-24 mb-3"/>
                      </div>
                      <h3 className="font-semibold text-xl">{t.h3ExclItinera}</h3>
                      <p>{t.pExclItinera}</p>
                    </div>
                  </div>
                  ...
                  <div className="md:w-1/4 sm:w-1/2">
                    <div className="px-4 py-6 transform transition duration-500 hover:scale-110">
                      <div className="flex justify-center">
                        <img src="/assets/icon/experience-field.svg" className="w-24 mb-3"/>
                      </div>
                      <h3 className="font-semibold text-xl">{t.h3Experience}</h3>
                      <p>{t.pExperience}</p>
                    </div>
                  </div>
                  ...
                  <div className="md:w-1/4 sm:w-1/2">
                    <div className="px-4 py-6 transform transition duration-500 hover:scale-110">
                      <div className="flex justify-center">
                        <img src="/assets/icon/sustainable-travel.svg" className="w-24 mb-3"/>
                      </div>
                      <h3 className="font-semibold text-xl">{t.h3Responsible}</h3>
                      <p>{t.pResponsible}</p>
                    </div>
                  </div>
                  ...
                  <div className="md:w-1/4 sm:w-1/2">
                    <div className="px-4 py-6 transform transition duration-500 hover:scale-110">
                      <div className="flex justify-center">
                        <img src="/assets/icon/small-group.svg" className="w-24 mb-3"/>
                      </div>
                      <h3 className="font-semibold text-xl">{t.h3SmallGroup}</h3>
                      <p>{t.pSmallGroup}</p>
                    </div>
                  </div>
                </div>
          ...
          <div className='lg:mx-20 mx-2 my-8' >
            <div className="mx-auto">
              <div className="">
                <h2 className="font-manrope text-4xl text-center font-bold text-gray-900">{t.team}</h2>
                <p className="text-lg text-gray-500 text-center">{}</p>
              </div>
              
              <div className="swiper teamswiper pb-10 grid lg:grid-cols-2 grid-cols-1 md:grid-cols-2">
                ...
                <div className="p-2">
                  ...
                  <p className='text-lg text-gray-700 leading-relaxed text-justify'>{t.pFounder}</p>
                  
                </div>

                <div className="group w-full flex-wrap flex items-start gap-8  transition-all duration-500 p-8  lg:flex-nowrap">
                  <div className=" w-full lg:w-48 h-64">
                    <img src="/img/other/abraham.jpg" alt="image" className="rounded h-full object-cover mx-auto lg:mx-0 lg:w-full object-top"/>
                  </div>
                  <div className="text-center lg:text-left lg:max-w-xs flex-1">
                    <div className="mb-5 pb-5 border-b border-solid border-gray-300">
                      <h6 className="text-lg text-gray-900 font-semibold mb-1">Abraham Ocon</h6>
                      <span className="text-sm text-gray-500 group-hover:text-secondary">{t.founder}</span>
                    </div>
                    <p className="text-gray-500 leading-6 mb-7">{t.work_funder}</p>
                    <div className="flex items-center gap-4 justify-center lg:justify-start">
                      <p className="cursor-pointer  py-3  text-gray-900 hover:text-white group w-12 h-12 rounded-full flex justify-center items-center bg-gray-100 transition-all duration-500 hover:text-secondary">
        ...
        <div className="bg-gray-200 py-20 shadow">
          <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center">
            <spm className="text-center text-lg font-semibold leading-8 text-gray-900">{t.spmFeatured}</spm>
            <div className="mx-auto mt-10 grid max-w-lg grid-cols-4 items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-5">
              <LazyLoadImage src="/assets/footer/mincetur-190x100.webp" className="col-span-2 max-h-12 w-full object-contain lg:col-span-1" />
              <LazyLoadImage src="/assets/footer/peru-brand-190x120.webp" className="col-span-2 max-h-12 w-full object-contain lg:col-span-1" />
              <LazyLoadImage src="/assets/footer/adventure-travel.webp" className="col-span-2 max-h-32 w-full object-contain lg:col-span-1" />
              <LazyLoadImage src="/assets/footer/viator.webp" className="col-span-2 max-h-12 w-full object-contain sm:col-start-2 lg:col-span-1" />
              <LazyLoadImage src="/assets/footer/Tripadvisor.webp" className="col-span-2 col-start-2 max-h-12 w-full object-contain sm:col-start-auto lg:col-span-1" />
            </div>
          </div>
        </div>
      </section>
