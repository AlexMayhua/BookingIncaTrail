...
export default function Navbar() {
    ...
    const { toursData, loading, getToursByCategory, getTourImage, getTourDescription } = useNavbarData()

    const router = useRouter()
    const { locale } = router;
    const t = locale === 'en' ? en : es;
    // Evitar href nulo en Link: usar fallback '/blog' si BRAND.blogUrl no está definido
    const blogUrl = BRAND.blogUrl ? (locale === 'en' ? BRAND.blogUrl : `${BRAND.blogUrl}/es`) : '/blog';
    ...
    const sustainableTours = loading ? [] : getToursByCategory("sustainable-tours");
    ...
    const navbarCategories = [
        { slug: 'inca-trail', data: incaTrail, label: t.inca_trail, subtitle: t.subtitle_inca_trail },
        { slug: 'salkantay', data: salkantay, label: t.salkantay, subtitle: t.subtitle_salkantay },
        { slug: 'machupicchu', data: machupicchu, label: t.machupicchu, subtitle: t.subtitle_machupicchu },
        { slug: 'choquequirao', data: choquequirao, label: t.choquequirao, subtitle: t.subtitle_choquequirao },
        { slug: 'ausangate', data: ausangate, label: t.ausangate, subtitle: t.subtitle_ausangate },
        { slug: 'rainbow-mountain', data: raimbow, label: t.rainbowmountain, subtitle: t.subtitle_rainbowmountain },
        { slug: 'inca-jungle', data: incaJungle, label: t.incajungle, subtitle: t.incajungle },
        { slug: 'day-tours', data: cuscoTours, label: t.cusco, subtitle: t.subtitle_cusco },
        { slug: 'peru-packages', data: perupackages, label: t.peru, subtitle: t.subtitle_peru },
        { slug: 'sacred-lakes', data: sacredLakes, label: t.sacredlakes, subtitle: t.subtitle_sacredlakes }, // ✅ RESTAURADO
        { slug: 'luxury-glamping', data: luxuryGlamping, label: t.luxuryglamping, subtitle: t.subtitle_luxuryglamping }, // ✅ RESTAURADO
        { slug: 'family-tours', data: familyTours, label: t.familytours, subtitle: t.subtitle_familytours }, // ✅ RESTAURADO
        { slug: 'sustainable-tours', data: sustainableTours, label: t.sustainabletours, subtitle: t.subtitle_sustainabletours } // ✅ RESTAURADO
    ];
    ...
    const getServiceImage = (category, serviceSlug) => {
        ...
        const serviceImageMap = {
            ...
            'Salkantay-and-Inca-Trail-7-days-family-friendly-trek': '/img/navbar/salkantay-trek.jpg',
            'Inca-Trail-and-the-Inca-Quarries-of-Cachiccata-4-Days-3-Nights': '/img/navbar/inka-trail.jpg',
            ...
            // Ausangate Tours
            'ausangate-and-rainbow-mountain-trek-3-days': '/img/navbar/ausangate-trek.jpeg',
            'Beyond-the-ordinary-trekking-ausangate-rainbow-mountain-and-red-valley-2-days-1-night': '/img/navbar/rainbow-montain-&-red-valley.jpg',
            'Eco-friendly-treks-in-Peru\'s-Andes-Mountains': '/img/navbar/ausangate-trek.jpeg',
            ...
            // Rainbow Mountain
            'rainbow-mountain-peru-and-red-valley': '/img/navbar/rainbow-montain-&-red-valley.jpg',
    ...
    return (
        <nav className='fixed w-full z-50'>
            {/* Navbar para móvil */}
            {isSmallScreen && (
                <div id='navbarMobile' className='flex items-center justify-between bg-primary py-3 px-3'>
                    ...
                    <ul className='flex gap-2 xs:gap-4'>
                        <li className="flex m-0 p-0 items-center justify-center">
                            <span className="inline-block w-5 h-5 xs:w-6 xs:h-6 text-secondary">
                                {/* Renderizar teléfono solo si existe */}
                                {BRAND.contactPhone ? (
                                    <a href={`tel:${BRAND.contactPhone}`} aria-label="Phone number">
                        ...
                        <li className="flex m-0 p-0 items-center justify-center">
                            <span className="inline-block w-5 h-5 xs:w-6 xs:h-6 text-secondary">
                                {/* Renderizar correo solo si existe */}
                                {BRAND.contactEmail ? (
                                    <a href={`mailto:${BRAND.contactEmail}`} aria-label="Email">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
                        ...
                        <li className="flex m-0 p-0 items-center justify-center">
                            ...
                            >
                                <USFlag className={`language-flag ${router.locale === 'en' ? 'active' : ''}`} />
                            </button>
                        </li>
                        ...
                        <li className="flex m-0 p-0 items-center justify-center">
                            ...
                            >
                                <ESFlag className={`language-flag ${router.locale === 'es' ? 'active' : ''}`} />
                            </button>
                        </li>
                        ...
                        <li className="flex m-0 p-0 items-center justify-center">
                            ...
                            >
                                <svg width="28px" height="20px" viewBox="0 0 53 49" className="transition-transform duration-300 group-hover:scale-110">
                                    <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" strokeLinecap="round">
                                        <g id="Group" transform="translate(1.000000, 1.000000)" stroke="#e6c200" strokeWidth="3" className="transition-all duration-300">
                                            <line x1="0.5" y1="0.5" x2="50.5" y2="0.5" id="Line" className="group-hover:stroke-[4]"></line>
                                            <line x1="0.5" y1="23.5" x2="44.5" y2="23.5" id="Line" className="group-hover:stroke-[4]"></line>
                                            <line x1="0.5" y1="46.5" x2="50.5" y2="46.5" id="Line" className="group-hover:stroke-[4]"></line>
                                        </g>
                                    </g>
                                </svg>
                            </button>
            ...
            {/* Navbar para desktop */}
            {!isSmallScreen && (
                <div className={navChange ? 'bg-primary/98 backdrop-blur-md w-full print:hidden lg:block hidden navbar-scrolled' : 'bg-primary w-full print:hidden lg:block hidden'}>
                        ...
                        <div className="navbar-compact-header">
                            <div className="compact-header-content">
                                ...
                                <div className="compact-quick-actions">
                                    {BRAND.contactPhone && (
                                        <a href={`tel:${BRAND.contactPhone}`} className="compact-action-btn phone">
                                    ...
                                    {BRAND.whatsapp && (
                                        <a href={`https://wa.me/${BRAND.whatsapp?.replace(/\D/g, '')}`} target="_blank" rel="noopener noreferrer" className="compact-action-btn whatsapp">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                    ...
                                    <a href={`mailto:${BRAND.contactEmail}`} className="compact-action-btn email">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                            <path d="M1.5 8.67v8.58a3 3 0 0 0 3 3h15a3 3 0 0 0 3-3V8.67l-8.928 5.493a3 3 0 0 1-3.144 0L1.5 8.67Z" />
                                            <path d="M22.5 6.908V6.75a3 3 0 0 0-3-3h-15a3 3 0 0 0-3 3v.158l9.714 5.978a1.5 1.5 0 0 0 1.572 0L22.5 6.908Z" />
                                        </svg>
                                ...
                                <Link href='/contact' className='compact-cta-btn'>
                                    {t.enquire}
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="compact-cta-arrow">
                    ...
                    <div className={navChange ? 'lg:hidden hidden' : '2xl:container 2xl:mx-auto xl:mx-12 mx-3 nav-topbar'}>
                        {/* Top Bar - Una sola fila con distribución optimizada */}
                        <div className='header-topbar-row'>
                            {/* Columna Izquierda: Logo con slogan */}
                            <div className='header-logo-section'>
                                <Link href='/' aria-label="Inicio" className="flex flex-col items-start">
                                    <CachedImage
                                        src="/assets/logo-Booking.svg"
                                        alt={BRAND.logo.alt}
                                        className="h-12 w-auto transform origin-center scale-[1.15]"
                                    />
                                    <span className="brand-slogan">{t.slogan || 'Your adventure starts here'}</span>
                                </Link>
                            </div>
                            ...
                            <div className='header-contact-section'>
                                {BRAND.contactPhone ? (
                                    <a href={`tel:${BRAND.contactPhone}`} className='contact-info-item'>
                                ...
                                {BRAND.contactEmail ? (
                                    <a href={`mailto:${BRAND.contactEmail}`} className='contact-info-item'>
                                        <span className="contact-icon-wrapper">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                                <path d="M1.5 8.67v8.58a3 3 0 0 0 3 3h15a3 3 0 0 0 3-3V8.67l-8.928 5.493a3 3 0 0 1-3.144 0L1.5 8.67Z" />
                                                <path d="M22.5 6.908V6.75a3 3 0 0 0-3-3h-15a3 3 0 0 0-3 3v.158l9.714 5.978a1.5 1.5 0 0 0 1.572 0L22.5 6.908Z" />
                            ...
                            <div className='header-actions-section'>
                                ...
                                <div className='secondary-nav-links'>
                                    <Link href={blogUrl} target="_blank" className='nav-link-item'>
                                        Blog
                                    </Link>
                                    <Link href='/about-us' className='nav-link-item'>
                                        {t.about}
                                    </Link>
                                    <Link href="https://www.tripadvisor.com.pe/Attraction_Review-g294314-d12614123-Reviews-Life_Expeditions-Cusco_Cusco_Region.html" target="_blank" className='nav-link-item'>
                                        {t.review}
                                    </Link>
                                ...
                                <div className='cta-social-stack'>
                                    ...
                                    <div className='social-icons-top'>
                                        {BRAND.social?.facebook && (
                                            <a href={BRAND.social.facebook} target="_blank" rel="noopener noreferrer" className="social-icon-mini" aria-label="Facebook">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                        ...
                                        {BRAND.social?.instagram && (
                                            <a href={BRAND.social.instagram} target="_blank" rel="noopener noreferrer" className="social-icon-mini" aria-label="Instagram">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                        ...
                                        {BRAND.social?.tiktok && (
                                            <a href={BRAND.social.tiktok} target="_blank" rel="noopener noreferrer" className="social-icon-mini" aria-label="TikTok">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                        ...
                                        {BRAND.social?.youtube && (
                                            <a href={BRAND.social.youtube} target="_blank" rel="noopener noreferrer" className="social-icon-mini" aria-label="YouTube">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                    ...
                                    <div className='cta-buttons-group'>
                                        <Link href='/travel-deals' className='cta-btn-outline'>
                                            {t.deals}
                                        </Link>
                    ...
                    {!isSmallScreen && (
                        <div id='navbarDesktop' className='bg-primary/95 border-t border-stone-700/30 relative'>
                            {/* Flecha izquierda */}
                            <button
                                onClick={() => scrollNavbar('left')}
                                className="navbar-scroll-arrow navbar-scroll-arrow-left"
                            ...
                            <div ref={navbarScrollRef} className='overflow-x-auto scrollbar-hide px-12'>
                                        ...
                                        <li key={category.slug} className="shrink-0">
                                            ...
                                            >
                                                <Link
                                                    ...
                                                    <span className='text-white text-xs xl:text-sm 2xl:text-base hover:text-stone-200 transition-colors duration-300 whitespace-nowrap'>{category.label}</span>
                                                    <svg className="dropdown-indicator ml-1 text-stone-300 group-hover:text-primary transition-colors duration-300" fill="currentColor" viewBox="0 0 20 20">
                                                    ...
                                                    <div className='mega-menu-grid'>
                                                        ...
                                                        <div className='mega-menu-services'>
                                                            <div className='mega-menu-services-header'>
                                                                <h3 className='mega-menu-category-title'>{category.subtitle}</h3>
                                                            ...
                                                            <ul className='mega-menu-services-list'>
                                                                {
                                                                    category.data.map((item, i) => (
                                                                        <li
                                                                            ...
                                                                            onMouseEnter={() => handleServiceHover(item.slug)}
                                                                            onMouseLeave={handleServiceLeave}
                                                                        >
                                                                            <Link href={`/${item.category}/${item.slug}`} className='mega-menu-service-link'>
                                                                                <span className='mega-menu-service-bullet'></span>
                                                                                <span className='mega-menu-service-title'>
                                                                                    {capitalizeWords(item.title)}
                                                                                </span>
                                                                                <svg className='mega-menu-service-arrow' viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                                        ...
                                                        <div className='mega-menu-description'>
                                                            <div className='mega-menu-description-content'>
                                                                <div className='mega-menu-description-label'>Descripción</div>
                                                                <div className='mega-menu-description-text'>
                                                                    {parser(getServiceDescription(category.slug, hoveredService))}
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className='mega-menu-image'>
                                                            <div className='mega-menu-image-wrapper'>
                                                                ...
                                                                <LazyLoadImage
                                                                    src={getServiceImage(category.slug, hoveredService)}
                            ...
                            <button
                                ...
                                className="navbar-scroll-arrow navbar-scroll-arrow-right"
            ...
            <div
                className={gender ? 'bottom-0 fixed lg:w-96 w-full sm:w-80 z-50 top-0 left-0 shadow-2xl overflow-y-auto' : 'z-50 bottom-0 fixed top-0 -left-[150%] shadow-2xl overflow-y-auto'}
                style={{
                    background: 'linear-gradient(180deg, #0d1117 0%, #1a1f2e 50%, #0d1117 100%)',
                    transition: 'all 0.4s cubic-bezier(0.4, 0, 0.2, 1)'
                }}
            >
                {/* Header del panel con gradiente azul */}
                <ul className='flex justify-between items-center px-4 py-5 border-b-2' style={{
                    background: 'linear-gradient(135deg, rgba(72, 114, 148, 0.25) 0%, rgba(72, 114, 148, 0.15) 100%)',
                    borderColor: '#487294',
                ...
                }}>
                    {
                        isSmallScreen ?
                            <li>
                                <Link href='/' onClick={() => setGender(false)} aria-label="Inicio">
                    ...
                    <li className="flex items-center justify-center gap-2">
                        ...
                        >
                            ...
                            <span className="absolute inset-0 rounded-full bg-secondary/20 scale-0 group-hover:scale-150 opacity-0 group-hover:opacity-100 transition-all duration-500 blur-xl"></span>
                        </a>
                    </li>
                    <li className="flex items-center justify-center">
                        ...
                        >
                            <svg width="22px" height="22px" viewBox="0 0 22 22" version="1.1" className="transition-transform duration-300 group-hover:rotate-90">
                                <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" strokeLinecap="round">
                                    <g id="Group-2" transform="translate(1.000000, 1.000000)" stroke="#0d1117" strokeWidth="2.5" className="transition-all duration-300">
                                        <line x1="0.5" y1="19.5" x2="19.5" y2="0.5" id="Line-2"></line>
                                        <line x1="19.5" y1="19.5" x2="0.5" y2="0.5" id="Line-3"></line>
                                    </g>
                                </g>
                            </svg>
                        </button>
                ...
                <div className="px-4 pt-6 pb-2">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg" style={{
                            background: 'linear-gradient(135deg, rgba(230, 194, 0, 0.15) 0%, rgba(230, 194, 0, 0.05) 100%)',
                            ...
                            <span className="text-xs font-bold text-secondary uppercase tracking-wider">Tours</span>
                        </div>
                        <div className="flex-1 h-px bg-gradient-to-r from-transparent via-secondary/50 to-transparent"></div>
                    </div>
                </div>
                ...
                <ul className="px-4 pb-6 space-y-1 text-base font-medium">
                    ...
                    <li className='accordion mb-2'>
                        <a
                            ...
                            style={isShowing ? {
                                background: 'linear-gradient(135deg, rgba(230, 194, 0, 0.2) 0%, rgba(230, 194, 0, 0.1) 100%)'
                            } : {}}
                        >
                            <span className="font-bold text-sm uppercase tracking-wide">{t.inca_trail}</span>
                            {isShowing ? (

                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2.5" stroke="currentColor" className="h-5 w-5 transition-transform duration-300 text-secondary">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 15.75 7.5-7.5 7.5 7.5" />
                                </svg>
                            ) : (
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2.5" stroke="currentColor" className="h-5 w-5 transition-transform duration-300 text-white/60">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                                </svg>
                            )}
                        </a>
                        <ul className={isShowing ? 'block mt-2 ml-2 space-y-1' : 'hidden'}>
                            {
                                incaTrail.map((item, i) => (
                                    <li className='flex' key={i}>
                                        <Link
                                            ...
                                            onClick={() => setGender(!gender)}
                                            className='py-2.5 px-4 text-sm text-white/70 w-full rounded-md transition-all duration-200 hover:bg-white/10 hover:text-white hover:shadow-md hover:translate-x-1 border-l-2 border-transparent hover:border-secondary flex items-center group'>
                                            <span className="w-1.5 h-1.5 rounded-full bg-secondary mr-3 opacity-0 group-hover:opacity-100 transition-opacity duration-200"></span>
                                            {capitalizeWords(item.title)}
                    ...
                    <li className='accordion mb-2'>
                        ...
                        >
                            ...
                            {isShowing1 ? (
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="h-5 w-5 transition-transform duration-300 text-secondary">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 15.75 7.5-7.5 7.5 7.5" />
                                </svg>
                            ) : (
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="h-5 w-5 transition-transform duration-300 text-white/60">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                                </svg>
                            )}

                        </a>
                        <ul className={isShowing1 ? 'block mt-2 ml-2 space-y-1' : 'hidden'}>
                            {
                    ...
                    <li className='accordion mb-2'>
                        ...
                        <ul className={isShowing2 ? 'block mt-2 ml-2 space-y-1' : 'hidden'}>
                            {
                    ...
                    <li className='accordion mb-2'>
                        ...
                        <ul className={isShowing3 ? 'block mt-2 ml-2 space-y-1' : 'hidden'}>
                            {
                    ...
                    <li className='accordion mb-2'>
                        ...
                        <ul className={isShowing4 ? 'block mt-2 ml-2 space-y-1' : 'hidden'}>
                            {
                    ...
                    <li className='accordion mb-2'>
                        ...
                        <ul className={isShowing5 ? 'block mt-2 ml-2 space-y-1' : 'hidden'}>
                            {
                    ...
                    <li className='accordion mb-2'>
                        ...
                        <ul className={isShowing7 ? 'block mt-2 ml-2 space-y-1' : 'hidden'}>
                            {
                                raimbow.map((item, i) => (
                                    <li className='flex' key={i} >
                                        <Link
                    ...
                    <li className='accordion mb-2'>
                        ...
                        <div className={isShowing6 ? 'block mt-2 ml-2 space-y-3' : 'hidden'}>
                            <ul className="space-y-1">
                                {
                                    incaJungle.map((item, i) => (
                                        <li className='flex mb-1' key={i} >
                                            <Link
                                                href={`/${item.category}/${item.slug}`}
                                                onClick={() => setGender(!gender)}
                                                className='py-2.5 px-4 text-sm text-slate-600 w-full rounded-md transition-all duration-200 hover:bg-gradient-to-r hover:from-primary hover:to-primary/80 hover:text-white hover:shadow-md hover:translate-x-1 border-l-2 border-transparent hover:border-secondary flex items-center group'>
                                                <span className="w-1.5 h-1.5 rounded-full bg-secondary mr-3 opacity-0 group-hover:opacity-100 transition-opacity duration-200"></span>
                                                {capitalizeWords(item.title)}
                    ...
                    <li className='mb-2'>
                        <Link
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="w-5 h-5 mr-3 text-white/60 group-hover:text-primary transition-colors duration-200">
                    ...
                    {/*<li className='py-1 border-b uppercase text-primary'>                        
                        <select
                            onChange={changeLanguage}
                            defaultValue={locale}
                            className="text-shadow-sm  bg-transparent tracking-wide"
                        >
                            <option className="text-primary" value="es">ES</option>
                            <option className="text-primary" value="en">EN</option>
                        </select>
                    </li>*/}
                    <li className='mb-4 mt-6'>
                        <div className='mx-4 px-5 py-4 rounded-xl border-2' style={{
                            background: 'linear-gradient(135deg, rgba(230, 194, 0, 0.08) 0%, rgba(230, 194, 0, 0.03) 100%)',
                            ...
                            <div className="flex gap-4 justify-center items-center">
                                ...
                                >
                                    <USFlag className={`language-flag ${router.locale === 'en' ? 'active' : ''}`} />
                                    <span className={`text-xs font-semibold ${router.locale === 'en' ? 'text-primary' : 'text-white'}`}>EN</span>
                                </button>
                                ...
                                >
                                    <ESFlag className={`language-flag ${router.locale === 'es' ? 'active' : ''}`} />
                                    <span className={`text-xs font-semibold ${router.locale === 'es' ? 'text-primary' : 'text-white'}`}>ES</span>
                                </button>
                ...
                <div className="flex justify-center items-center p-4 mt-2 border-t border-secondary/30" style={{
                    background: 'linear-gradient(180deg, rgba(250, 246, 233, 0.95) 0%, rgba(255, 255, 255, 0.85) 100%)'
                }}>
                    <LazyLoadImage
