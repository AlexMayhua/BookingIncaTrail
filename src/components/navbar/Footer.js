        ...
        <footer className='print:hidden footer-modern'>
                ...
                <div className="footer-grid">
                    ...
                    <div className="footer-links-column">
                        ...
                        <ul className="footer-links">
                            {[
                                ...
                                { href: '/terms-conditions/complaintsBook', label: t.complaintsBook },
                                { href: '/contact', label: t.contact }
                            ].map((link, idx) => (
                                <li key={idx}>
                                    <Link href={link.href} className="footer-link">
                                        <svg className="link-arrow" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <div className="footer-links-column">
                        ...
                        <ul className="footer-links">
                            {[
                                ...
                                { href: '/alternative-tours', label: t.AlternativeTreks }
                            ].map((link, idx) => (
                                <li key={idx}>
                                    <Link href={link.href} className="footer-link">
                                        <svg className="link-arrow" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <div className="footer-contact-column">
                        ...
                        <div className="footer-contact-cards">
                            {/* Teléfono */}
                            <a href={`tel:${BRAND.contactPhone}`} className="footer-contact-card">
                            ...
                            {/* WhatsApp */}
                            <a href={`https://wa.me/${BRAND.whatsapp?.replace(/\D/g, '')}`} target="_blank" rel="noopener noreferrer" className="footer-contact-card whatsapp-card">
                            ...
                            {/* Ubicación */}
                            <a href='https://maps.app.goo.gl/qFAvCyjs4FFXtf1B7' target="_blank" rel="noopener noreferrer" className="footer-contact-card">
            ...
            <div className="footer-copyright">
                ...
                <div className="copyright-links">
                    <Link href='/terms-conditions/privacy-policy' className="copyright-link">
                        {t.privacy_policy}
                    </Link>
